package dev.kevalkanpariya.featuretesteduco.presentation.profile.student_profile.settings.password_change
...
fun PasswordChangeScreen() {
    ...
    Column(
        ...
        Column(
            ...
            Text(text = "Does not match with old password", color = ErrorRed)
