...
import dev.kevalkanpariya.educo.core.presentation.components.buttons.FaceBookButton
import dev.kevalkanpariya.educo.core.presentation.components.buttons.GoogleButton
        ...
        ConstraintLayout(
            ...
            Surface(
                ...
                Row(
                    ...
                    TextButton(onClick = onSignUpWithFormClicked){
                        Text(
            ...
            TextButton(modifier = Modifier.layoutId(navigateToSignInBtnRef), onClick = onSignInClicked) {
                Text(
